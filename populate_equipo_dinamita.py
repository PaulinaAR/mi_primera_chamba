...
from mi_primera_app.models import EquipoDinamita
...
def populate(N=5):
    for entry in range(N):
        ...
        equipo_dinamita = EquipoDinamita.objects.get_or_create(first_name=fake_first_name, last_name=fake_last_name, 
